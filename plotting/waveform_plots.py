...
record_1 = wfdb.rdrecord(DS_DIRECTORY + 'n17')
...
SAFE_DIRECTORY = '/media/jonas/SSD_new/CMS/Semester_4/research_project/datasets/figures/paf_pred_challenge/deleted_segments/'
#save_figure.savefig(SAFE_DIRECTORY + 'n17_no_signal.png')
