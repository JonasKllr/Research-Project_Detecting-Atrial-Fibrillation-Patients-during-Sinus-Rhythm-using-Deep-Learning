...
from data_pipeline.less_segments import less_segments
...
for learning_rate_choice in LEARNING_RATE:
    ...
    for train_index, test_index in kfold.split(patient_number_array_unique):
        ...
        output_layer = tf.keras.layers.Dense(1)(base_output_1)

        model = tf.keras.Model(inputs=model.input, outputs=output_layer, name='Model_3_transfer_learning')
