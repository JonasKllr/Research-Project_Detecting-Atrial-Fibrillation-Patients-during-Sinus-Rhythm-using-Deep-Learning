...
def build_model_age(LEARNING_RATE, KERNEL_SIZE, POOLING_LAYER):
    RECORD_LENGTH = 1280
    ...
    x_1 = tf.keras.layers.GlobalAveragePooling1D()(x_1)
    x_1 = tf.keras.layers.Dense(20, activation='relu')(x_1)
    x_1 = tf.keras.layers.Dense(5)(x_1)
    ...
    x_2 = tf.keras.layers.GlobalAveragePooling1D()(x_2)
    x_2 = tf.keras.layers.Dense(20, activation='relu')(x_2)
    x_2 = tf.keras.layers.Dense(5)(x_2)
...
if __name__ == '__main__':
    ...
    model = build_model_age(LEARNING_RATE=0.001, KERNEL_SIZE=3, POOLING_LAYER='max_pool')
    print(model.summary())
    print(model.name)