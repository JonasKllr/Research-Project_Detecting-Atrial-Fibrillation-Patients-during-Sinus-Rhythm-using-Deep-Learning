...
def eval_models_one_by_one(test_data):
    for i in range(5):
        ...
        #MODEL_DIR = f'/media/jonas/SSD_new/CMS/Semester_4/research_project/history/transfer_learning_less_segments_batch_8/history/Model_3_transfer_learning_6/learning_rate_0.01/fold_{i+1}/model'
        ...
        MODEL_DIR = f'/media/jonas/SSD_new/CMS/Semester_4/research_project/history/transfer_learning_lesser5_segments_batch_4/history/Model_3_transfer_learning_3/learning_rate_0.01/fold_{i+1}/model'
