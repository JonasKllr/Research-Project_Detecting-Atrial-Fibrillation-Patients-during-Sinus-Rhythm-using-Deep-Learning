...
def eval_models_one_by_one(test_data):
    for i in range(5):
        ...
        # load the model
        MODEL_DIR = f'/media/jonas/SSD_new/CMS/Semester_4/research_project/history/age/correct/cross_validation/history/Model_age_regression/kernel_6/pooling_max_pool/learning_rate_0.001/fold_{i+1}/model'
