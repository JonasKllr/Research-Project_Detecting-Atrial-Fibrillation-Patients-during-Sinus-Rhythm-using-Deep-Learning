    ...
    for subdir, dir, files in os.walk(DIR): 
        for file in files:
            ...
            if file.endswith('history.csv'):
                ...
                index_min = train_result['val_loss'].idxmin()   # 'val_mean_squared_error', 'val_loss'
...
if __name__ == '__main__':
    ...
    DIR = '/media/jonas/SSD_new/CMS/Semester_4/research_project/history/age/linear_no_zeros/history/Model_age_regression_linear/kernel_6'
