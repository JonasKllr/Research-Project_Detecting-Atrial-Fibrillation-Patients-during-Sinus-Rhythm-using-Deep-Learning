...
def eval_models_one_by_one(test_data):
    for i in range(5):
        ...
        MODEL_DIR = f'/media/jonas/SSD_new/CMS/Semester_4/research_project/history/transfer_learning_less_segments_batch_4/history/Model_3_transfer_learning_4/learning_rate_0.001/fold_{i+1}/model'
