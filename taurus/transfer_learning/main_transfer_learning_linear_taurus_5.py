...
for learning_rate_choice in LEARNING_RATE:
    ...
    for train_index, test_index in kfold.split(patient_number_array_unique):
        ...
        base_output_1 = model.get_layer('dropout_frozen').output
        base_output_2 = model.get_layer('dropout_2_frozen').output
        ...
        model = tf.keras.Model(inputs=model.input, outputs=output_layer, name='Model_3_transfer_learning_5')
