...
def build_model_age_regression_linear(LEARNING_RATE, KERNEL_SIZE, POOLING_LAYER):
    RECORD_LENGTH = 1280
    ...
    model = tf.keras.Model(inputs=[input_layer_1, input_layer_2], outputs=output_layer, name='Model_age_regression_linear')
...
if __name__ == '__main__':
    ...
    model = build_model_without_tuner_3(LEARNING_RATE=0.001, KERNEL_SIZE=6, POOLING_LAYER='max_pool')
    print(model.summary())
    print(model.name)